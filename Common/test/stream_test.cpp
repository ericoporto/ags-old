...
TEST(Stream, AlignedStream) {
    ...
    EXPECT_EQ(tricky_data_out.a, tricky_data_in.a);
    EXPECT_EQ(tricky_data_out.b, tricky_data_in.b);
    EXPECT_EQ(tricky_data_out.d[0], tricky_data_in.d[0]);
    EXPECT_EQ(tricky_data_out.d[1], tricky_data_in.d[1]);
    EXPECT_EQ(tricky_data_out.d[2], tricky_data_in.d[2]);
    EXPECT_EQ(tricky_data_out.e, tricky_data_in.e);
    EXPECT_EQ(tricky_data_out.f[0], tricky_data_in.f[0]);
    EXPECT_EQ(tricky_data_out.g[0], tricky_data_in.g[0]);
    EXPECT_EQ(tricky_data_out.h[0], tricky_data_in.h[0]);
    EXPECT_EQ(tricky_data_out.i[0], tricky_data_in.i[0]);
    EXPECT_EQ(tricky_data_out.j, tricky_data_in.j);
    EXPECT_EQ(tricky_data_out.k, tricky_data_in.k);
    EXPECT_EQ(tricky_data_out.l, tricky_data_in.l);
    EXPECT_EQ(tricky_data_out.m, tricky_data_in.m);
    EXPECT_EQ(tricky_data_out.n, tricky_data_in.n);
    EXPECT_EQ(tricky_data_out.i64a, tricky_data_in.i64a);
    EXPECT_EQ(tricky_data_out.o, tricky_data_in.o);
    EXPECT_EQ(tricky_data_out.i64b, tricky_data_in.i64b);
    EXPECT_EQ(tricky_data_out.p, tricky_data_in.p);
    EXPECT_EQ(tricky_data_out.i64c, tricky_data_in.i64c);
    EXPECT_EQ(tricky_data_out.q, tricky_data_in.q);
    EXPECT_EQ(tricky_data_out.r, tricky_data_in.r);
    EXPECT_EQ(tricky_data_out.i64d, tricky_data_in.i64d);
    EXPECT_EQ(tricky_data_out.final, tricky_data_in.final);
